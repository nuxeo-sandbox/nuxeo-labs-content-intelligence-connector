 ...
 */
@Operation(id = HylandKDAvailableAgentsOp.ID, category = "Hyland Content Intelligence",
        label = "Get Available KD Agents (Local)", description = ""
        ...
        + " This is NOT the full list of agents declared on the CIC platform; use HylandKnowledgeDiscovery.getAllAgents"
        + " for that.")
