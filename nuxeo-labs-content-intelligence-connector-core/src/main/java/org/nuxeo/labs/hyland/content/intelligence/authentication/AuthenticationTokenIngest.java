 ...
 */
public class AuthenticationTokenIngest extends AuthenticationToken {

    public AuthenticationTokenIngest(String authFullUrl, AuthenticationTokenParams params) {
