 ...
 */
@Operation(id = HylandAgentsInvokeTaskOp.ID, category = "Hyland Agent Builder", label = "Invoke Task Agent",
        description = ""
...
public class HylandAgentsInvokeTaskOp {
    ...
    public Blob run() {
        ...
        ServiceCallResult result = agentsService.invokeAgent(AgentType.TASK, configName, agentId, agentVersion,
                jsonPayloadStr,
                extraHeaders);
